...
rem
cl /nologo /O2 /Ob2 /Zi /MD /W3 /DWIN32 %CFLAGS% /DUNICODE /D_UNICODE /DCONSOLE /c posix2winexec.c /Fd%SNAM% /Fo%SNAM%.obj
rc /l 0x409 /n /d "NDEBUG" %RCOPTS% /d STR_VERSION=\"%SVER%\" /d STR_INTNAME=\"%SNAM%\" /d CSV_VERSION=%CVER% /fo %SNAM%.res posix2winexec.rc
